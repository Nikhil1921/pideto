    ...
    function updatestatus($id,$status=""){
        ...
        if($id == NULL)
            ...
            if($status == ORDER_DECLINE){
                ...
                $message = _l("Your Order No. #order_no# is declined by Pideto.");
            ...
            if($status == ORDER_DELIVERED){
                ...
                $message = _l("Thanks being with Pideto, Your Order No. #order_no# is delivered, Please share your reviews.");
                $message = str_replace("#order_no#",$order->order_no,$message);
            }
            if($title != "" && $message != ""){
